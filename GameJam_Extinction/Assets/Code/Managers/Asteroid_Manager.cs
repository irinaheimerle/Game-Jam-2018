...
public class Asteroid_Manager : MonoBehaviour
{
	...
	private static Asteroid_Manager instance;
	...
	{
		foreach(Asteroid ass in instance.asteroidList)
		{
			GameObject.Destroy(ass.gameObject);
		}
		instance.asteroidList = new List<Asteroid>();
	}
